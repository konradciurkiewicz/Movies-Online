 ...
 * checks fail.
 *
 * When adding metadata to a class, you can override the "Videos" group of
 ...
 *     }
 *
 * Whenever you validate that object in the "Videos" group, the group sequence
 * will be validated:
 *
 *     $validator->validate($address);
 *
 * If you want to execute the constraints of the "Videos" group for a class
...
class GroupSequence
{
     ...
     * "Videos" group. When validating that class in the "Videos" group, the
     * group sequence is used instead, but still the "Videos" group should be
