...
use PageBundle\Mailer\UserMailer;
...
class UserManager {
    ...
    public function sendResetPasswordLink($userEmail) {
        ...
        $User = $this->doctrine->getRepository('PageBundle:User')
        ...
        $emailBody = $this->templating->render('PageBundle:Email:passwdResetLink.html.twig', array(
            'resetUrl' => $resetUrl
        ));
    ...
    public function resetPassword($actionToken) {
        ...
        $emailBody = $this->templating->render('PageBundle:Email:newPassword.html.twig', array(
    ...
    public function registerUser(User $User) {
        ...
        $emaiBody = $this->templating->render('PageBundle:Email:accountActivation.html.twig', array(
