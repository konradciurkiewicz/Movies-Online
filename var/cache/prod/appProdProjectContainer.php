...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'page.twig_extension' => 'getPage_TwigExtensionService',
            ...
            'security.firewall.map.context.page_security' => 'getSecurity_Firewall_Map_Context_PageSecurityService',
            ...
            'security.user.provider.concrete.page_users' => 'getSecurity_User_Provider_Concrete_PageUsersService',
            'security.user_checker.page_security' => 'getSecurity_UserChecker_PageSecurityService',
        ...
        $this->aliases = array(
            ...
            'security.user_checker.main' => 'security.user_checker.page_security',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'PageBundle', ($this->targetDirs[3].'/app/Resources/PageBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'PageBundle', ($this->targetDirs[3].'/src/PageBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'konradc_gdzie', 'user' => 'konradc_gdzie', 'password' => 'dedur999', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/PageBundle/Entity'))), 'PageBundle\\Entity');
        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('PageBundle' => 'PageBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e3e7fc6873eb5cd09a8cc35ec0f9bbbafda0a2e72f30680e19e7cd24024306a2');
        return $instance;
    }
    ...
    protected function getPage_TwigExtensionService()
    {
        return $this->services['page.twig_extension'] = new \PageBundle\Twig\Extension\PageExtension($this->get('doctrine'));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('PageBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 13))));
    }
    protected function getSecurity_FirewallService()
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.page_security' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'), 'security.firewall.map.context.main' => NULL)), $this->get('event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.page_users')), 'main', $b, $this->get('event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '57320de7bd58e2.65137825', $b, $this->get('security.authentication.manager')), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'main', NULL, NULL, NULL, $b, false));
    }
    protected function getSecurity_Firewall_Map_Context_PageSecurityService()
    {
        $a = $this->get('security.token_storage');
        $b = $this->get('security.user.provider.concrete.page_users');
        ...
        $h = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $b), 'fdsa34r4t545yu8k89p6hgf3sdcsfgh4trfge', 'page_security', array('lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'remember_me_parameter' => 'login[remember_me]', 'name' => 'REMEMBERME', 'secure' => false, 'httponly' => true, 'always_remember_me' => false), $c);
        $i = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $e, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($e, 'page_index'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '_logout'));
        ...
        $k->setOptions(array('login_path' => 'page_login', 'default_target_path' => 'page_index', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $k->setProviderKey('page_security');
        $l = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($f, $e, array(), $c);
        $l->setOptions(array('login_path' => 'page_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));
        $m = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $g, $j, $e, 'page_security', $k, $l, array('check_path' => '_check_path', 'username_parameter' => 'login[username]', 'password_parameter' => 'login[password]', 'use_forward' => false, 'require_previous_session' => true, 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $c, $d, NULL);
        $m->setRememberMeServices($h);
        return $this->services['security.firewall.map.context.page_security'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $b), 'page_security', $c, $d), 2 => $i, 3 => $m, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($a, $h, $g, $c, $d, true, $j), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '57320de7bd58e2.65137825', $c, $g), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $e, 'page_security', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, 'page_login', false), NULL, NULL, $c, false));
    }
    ...
    protected function getSecurity_UserChecker_PageSecurityService()
    {
        return $this->services['security.user_checker.page_security'] = new \Symfony\Component\Security\Core\User\UserChecker();
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('support@gdzie-ogladac.pl');
        $a->setPassword('dedur999');
        $a->setAuthMode(NULL);
        $this->services['swiftmailer.mailer.default.transport.real'] = $instance = new \Swift_Transport_EsmtpTransport(new \Swift_Transport_StreamBuffer(new \Swift_StreamFilters_StringReplacementFilterFactory()), array(0 => $a), $this->get('swiftmailer.mailer.default.transport.eventdispatcher'));
        $instance->setHost('gdzie-ogladac.pl');
        $instance->setPort(25);
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('page.twig_extension'));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'DoctrineBundle', 6 => 'SensioFrameworkExtraBundle', 7 => 'AppBundle', 8 => 'PageBundle', 9 => 'AsseticBundle', 10 => 'KnpPaginatorBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('fdsa34r4t545yu8k89p6hgf3sdcsfgh4trfge');
    }
    protected function getUserMailerService()
    {
        return $this->services['user_mailer'] = new \PageBundle\Mailer\UserMailer($this->get('swiftmailer.mailer.default'), 'support@gdzie-ogladac.pl', 'Gdzie Oglądać');
    }
    protected function getUserManagerService()
    {
        return $this->services['user_manager'] = new \PageBundle\Manager\UserManager($this->get('doctrine'), $this->get('router'), $this->get('templating'), $this->get('security.encoder_factory'), $this->get('user_mailer'));
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/account-settings'), array(0 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/user-panel'), array(0 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/form'), array(0 => 'ROLE_USER'), NULL);
        return $instance;
    }
    protected function getSecurity_Authentication_ManagerService()
    {
        $a = $this->get('security.user_checker.page_security');
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.page_users'), $a, 'page_security', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($a, 'fdsa34r4t545yu8k89p6hgf3sdcsfgh4trfge', 'page_security'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57320de7bd58e2.65137825'), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57320de7bd58e2.65137825')), true);
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('page_security', '_logout', 'logout', '_csrf_token', NULL);
        return $instance;
    }
    ...
    protected function getSecurity_User_Provider_Concrete_PageUsersService()
    {
        return $this->services['security.user.provider.concrete.page_users'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'PageBundle:User', 'username', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'konradc_gdzie',
            'database_user' => 'konradc_gdzie',
            'database_password' => 'dedur999',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'gdzie-ogladac.pl',
            'mailer_user' => 'support@gdzie-ogladac.pl',
            'mailer_password' => 'dedur999',
            'secret' => 'fdsa34r4t545yu8k89p6hgf3sdcsfgh4trfge',
            'locale' => 'pl',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'fdsa34r4t545yu8k89p6hgf3sdcsfgh4trfge',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'gdzie-ogladac.pl',
            'swiftmailer.mailer.default.transport.smtp.username' => 'support@gdzie-ogladac.pl',
            'swiftmailer.mailer.default.transport.smtp.password' => 'dedur999',
