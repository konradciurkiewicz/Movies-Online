...
/**
 * Videos implementation of {@link ClassMetadataInterface}.
 *
...
class ClassMetadata extends GenericMetadata implements ClassMetadataInterface
{
     ...
     *
     * For each class, the group "Videos" is an alias for the group
     ...
     * "Videos" belong to both of these groups, unless the class defines
     * a group sequence.
     *
     * If a class defines a group sequence, validating the class in "Videos"
     * will validate the group sequence. The constraints assigned to "Videos"
