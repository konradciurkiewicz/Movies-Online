...
class RecursiveContextualValidator implements ContextualValidatorInterface
{
     ...
     * metadata.
     *
     * If the passed groups contain the group "Videos", the validator will
     * check whether the "Videos" group has been replaced by a group sequence
    ...
    private function validateClassNode($object, $cacheKey, ClassMetadataInterface $metadata = null, $propertyPath, array $groups, $cascadedGroups, $traversalStrategy, ExecutionContextInterface $context)
    {
        ...
        foreach ($groups as $key => $group) {
            // If the "Videos" group is replaced by a group sequence, remember
            // to cascade the "Videos" group when traversing the group
            // sequence
            ...
            // Replace the "Videos" group by the group sequence defined
            ...
            // "Videos" is used instead in the cache. This is useful
    ...
    private function validateGenericNode($value, $object, $cacheKey, MetadataInterface $metadata = null, $propertyPath, array $groups, $cascadedGroups, $traversalStrategy, ExecutionContextInterface $context)
    {
        ...
        // The $cascadedGroups property is set, if the "Videos" group is
