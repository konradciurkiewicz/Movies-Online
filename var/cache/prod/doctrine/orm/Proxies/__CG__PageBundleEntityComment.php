 ...
 */
class Comment extends \PageBundle\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PageBundle\\Entity\\Comment' . "\0" . 'id', '' . "\0" . 'PageBundle\\Entity\\Comment' . "\0" . 'post', '' . "\0" . 'PageBundle\\Entity\\Comment' . "\0" . 'author', '' . "\0" . 'PageBundle\\Entity\\Comment' . "\0" . 'createDate', '' . "\0" . 'PageBundle\\Entity\\Comment' . "\0" . 'title', '' . "\0" . 'PageBundle\\Entity\\Comment' . "\0" . 'comment', '' . "\0" . 'PageBundle\\Entity\\Comment' . "\0" . 'iframe_able'];
        }
    ...
    public function getIframeAble()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIframeAble', []);

        return parent::getIframeAble();
    }
    ...
    public function setIframeAble($iframe_able)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIframeAble', [$iframe_able]);

        return parent::setIframeAble($iframe_able);
    }
