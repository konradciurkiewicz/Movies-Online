...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'konradc_gdzie', 'user' => 'konradc_gdzie', 'password' => 'dedur999', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_05b62dc0622f6e591bbd9a543f2826ac0296063ee653b59bd8a9f4da218617b2');
    ...
    /**
     * Gets the 'page.twig_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PageBundle\Twig\Extension\PageExtension A PageBundle\Twig\Extension\PageExtension instance.
     */
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.page_security' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'), 'security.firewall.map.context.main' => NULL)), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_PageSecurityService()
    {
        ...
        return $this->services['security.firewall.map.context.page_security'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $b), 'page_security', $c, $d), 2 => $i, 3 => $m, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($a, $h, $g, $c, $d, true, $j), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '57388c1000dea3.37557683', $c, $g), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $e, 'page_security', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, 'page_login', false), NULL, NULL, $c, false));
    }
    ...
    /**
     * Gets the 'security.user_checker.page_security' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * This method always returns the same instance of the service.
     *
     * @return \PageBundle\Mailer\UserMailer A PageBundle\Mailer\UserMailer instance.
     */
     ...
     * This method always returns the same instance of the service.
     *
     * @return \PageBundle\Manager\UserManager A PageBundle\Manager\UserManager instance.
     */
    ...
    /**
     * Gets the 'security.user.provider.concrete.page_users' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
