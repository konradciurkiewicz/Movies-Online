 ...
 */
class User extends \PageBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PageBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'PageBundle\\Entity\\User' . "\0" . 'username', '' . "\0" . 'PageBundle\\Entity\\User' . "\0" . 'email', '' . "\0" . 'PageBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'PageBundle\\Entity\\User' . "\0" . 'plainPassword', '' . "\0" . 'PageBundle\\Entity\\User' . "\0" . 'accountNonExpired', '' . "\0" . 'PageBundle\\Entity\\User' . "\0" . 'accountNonLocked', '' . "\0" . 'PageBundle\\Entity\\User' . "\0" . 'credentialsNonExpired', '' . "\0" . 'PageBundle\\Entity\\User' . "\0" . 'enabled', '' . "\0" . 'PageBundle\\Entity\\User' . "\0" . 'roles', '' . "\0" . 'PageBundle\\Entity\\User' . "\0" . 'actionToken', '' . "\0" . 'PageBundle\\Entity\\User' . "\0" . 'registerDate', '' . "\0" . 'PageBundle\\Entity\\User' . "\0" . 'rules', '' . "\0" . 'PageBundle\\Entity\\User' . "\0" . 'avatarFile'];
        }
