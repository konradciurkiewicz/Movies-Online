...
class ControllerNameParserTest extends TestCase
{
    ...
    public function testParse()
    {
        ...
        $this->assertEquals('TestBundle\FooBundle\Controller\DefaultController::indexAction', $parser->parse('FooBundle:Videos:index'), '->parse() converts a short a:b:c notation string to a class::method string');
        ...
        $this->assertEquals('TestBundle\Fabpot\FooBundle\Controller\DefaultController::indexAction', $parser->parse('SensioFooBundle:Videos:index'), '->parse() converts a short a:b:c notation string to a class::method string');
        $this->assertEquals('TestBundle\Sensio\Cms\FooBundle\Controller\DefaultController::indexAction', $parser->parse('SensioCmsFooBundle:Videos:index'), '->parse() converts a short a:b:c notation string to a class::method string');
        $this->assertEquals('TestBundle\FooBundle\Controller\Test\DefaultController::indexAction', $parser->parse('FooBundle:Test\\Videos:index'), '->parse() converts a short a:b:c notation string to a class::method string');
        $this->assertEquals('TestBundle\FooBundle\Controller\Test\DefaultController::indexAction', $parser->parse('FooBundle:Test/Videos:index'), '->parse() converts a short a:b:c notation string to a class::method string');
    ...
    public function testBuild()
    {
        ...
        $this->assertEquals('FooBundle:Videos:index', $parser->build('TestBundle\FooBundle\Controller\DefaultController::indexAction'), '->parse() converts a class::method string to a short a:b:c notation string');
    ...
    {
        return array(
            array('FoodBundle:Videos:index', 'FooBundle:Videos:index'),
            array('CrazyBundle:Videos:index', false),
        );
    }
