...
class TemplateGuesserTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGuessTemplateName()
    {
        ...
        $this->assertEquals('FooBundle:Foo:videoslist.html.twig', (string) $templateReference);
    }
    ...
    public function testGuessTemplateNameWithParentBundle()
    {
        ...
        $this->assertEquals('FooBundle:Bar:videoslist.html.twig', (string) $templateReference);
    }
    ...
    public function testGuessTemplateNameWithCascadingParentBundle()
    {
        ...
        $this->assertEquals('FooBundle:FooBar:videoslist.html.twig', (string) $templateReference);
    }
    ...
    public function testGuessTemplateWithoutBundle()
    {
        ...
        $this->assertEquals(':OutOfBundle:videoslist.html.twig', (string) $templateReference);
    }
