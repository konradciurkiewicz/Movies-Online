 ...
 *
 * Additionally, the metadata stores whether the "Videos" group is overridden
...
interface ClassMetadataInterface extends MetadataInterface
{
    ...
    /**
     * Returns whether the "Videos" group is overridden by a group sequence.
     *
     * If it is, you can access the group sequence with {@link getGroupSequence()}.
     *
     * @return bool Returns true if the "Videos" group is overridden
     *
     * @see \Symfony\Component\Validator\Constraints\GroupSequence
     */
    ...
    /**
     * Returns the group sequence that overrides the "Videos" group for this
     * class.
     *
    ...
    /**
     * Returns whether the "Videos" group is overridden by a dynamic group
     ...
     *
     * @return bool Returns true if the "Videos" group is overridden by
